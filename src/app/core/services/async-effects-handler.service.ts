...
export class AsyncEffectsHandler implements OnDestroy {
     ...
     *
     * @param actions    - instance of one of our actions where the service is provided,
     ...
     */
    public setActionsEffect(actions: ActionType[], effect: any, actionHook: ActionHook): void {
